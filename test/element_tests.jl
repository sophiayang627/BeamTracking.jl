...
# -- beams
zi1 = Coords(8);
zi1.x  .= [ 0.000,  0.000,  0.000,  0.002,  0.00200, -0.00200,  0.00200,  0.00200];
zi1.px .= [ 0.000,  0.000,  0.000,  0.000,  0.00075, -0.00075,  0.00075,  0.00075];
zi1.y  .= [ 0.000,  0.000,  0.000,  0.001,  0.00100, -0.00100,  0.00100,  0.00100];
zi1.py .= [ 0.000,  0.000,  0.000,  0.000,  0.00030, -0.00030,  0.00030,  0.00030];
zi1.z  .= [ 0.000,  0.000,  0.000,  0.000,  0.00000,  0.00000,  0.00000,  0.00000];
zi1.pz .= [ 0.001,  0.000, -0.001,  0.001,  0.00100,  0.00100,  0.00100,  0.00100];
zf1 = Coords(8);
